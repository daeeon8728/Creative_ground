  ...
  return (
    <div className="sculpt-toolbar">
      <div className="sculpt-toolbar-header">
        <span className="sculpt-title">🖐️ Sculpt Mode Active</span>
      </div>
      ...
      <div className="sculpt-controls">
        <div className="sculpt-control-group">
          ...
          <div className="sculpt-toggle-group">
            <button
              className={`sculpt-toggle-btn ${sculptBrushType === 'push' ? 'active' : ''}`}
              onClick={() => setSculptBrushType('push')}
            >
              Push (들어가게)
            </button>
            <button
              className={`sculpt-toggle-btn ${sculptBrushType === 'pull' ? 'active' : ''}`}
              onClick={() => setSculptBrushType('pull')}
            >
              Pull (나오게)
            </button>
          </div>
        ...
        <div className="sculpt-control-group">
          ...
          <input
            ...
            onChange={(e) => setSculptBrushStrength(parseFloat(e.target.value))}
            className="sculpt-range"
          />
        </div>
      </div>
